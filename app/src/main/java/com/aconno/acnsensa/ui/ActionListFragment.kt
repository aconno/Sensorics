 ...
 * [ActionListFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [ActionListFragment.newInstance] factory method to
...
class ActionListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val v = inflater.inflate(R.layout.fragment_action_list, container, false)
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): ActionListFragment {
