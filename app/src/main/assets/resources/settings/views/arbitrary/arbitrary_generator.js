function generateKeyValue(key, value) {
    return '<div style="margin-top: 1em;" class="card card-body" >'
        ...
        + '<input type="text" onchange="onValueUpdate(\''+key+'\',this.value)" class="holo" style="width: 100%; margin-top: 0.5em;" id="arbitrary_item_value" value="' + value + '" class="form-control">'
