...
interface Bluetooth {
    ...
    fun <T : DeviceSpec> startScanForDevice(device: Class<T>, consumer: Consumer<ScanResult>? = null): Disposable?
    fun startScanForDevices(devices: List<Class<out DeviceSpec>>, consumer: Consumer<ScanResult>? = null): Disposable?
